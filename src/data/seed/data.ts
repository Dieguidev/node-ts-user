...
export const seedData = {
  ...
  users: [
    { username: 'Test 1', email: 'test1@google.com', password: bcryptAdapter.hash('123456') },
    { username: 'Test 2', email: 'test2@google.com', password: bcryptAdapter.hash('123456') },
    { username: 'Test 3', email: 'test3@google.com', password: bcryptAdapter.hash('123456') },
    { username: 'Test 4', email: 'test4@google.com', password: bcryptAdapter.hash('123456') },
    { username: 'Test 5', email: 'test5@google.com', password: bcryptAdapter.hash('123456') },
    { username: 'Test 6', email: 'test6@google.com', password: bcryptAdapter.hash('123456') },
  ],
